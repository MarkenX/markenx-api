@ApplicationModule(
        ...
        allowedDependencies = {
                ...
                "game.dimensions :: commands",
                "game.dimensions :: aggregates",
                "game.consumers :: commands",
                "game.consumers :: aggregates",
                "game.actions :: commands",
                "game.actions :: aggregates",
                "game.events :: commands",
                "game.events :: aggregates",
                "game.actions :: valueobjects"
        }
)
